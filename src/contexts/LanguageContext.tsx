...
const translations: Record<Language, Record<string, string>> = {
  mn: {
    ...
    unsave: "Хадгалснаас устгах",
    unsaveItemTitle: "Устгахдаа итгэлтэй байна уу?",
    unsaveItemConfirmation: "Та энэ зүйлийг хадгалсан жагсаалтаас устгахдаа итгэлтэй байна уу?",
    unsaveButtonLabel: "Устгах",
    unsaveSuccessTitle: "Амжилттай",
    unsaveSuccessDesc: "Хадгалсан зүйлсээс устгагдлаа.",
    unsaveErrorGeneric: "Устгахад алдаа гарлаа.",
    ...
    resendVerificationEmail: "Дахин баталгаажуулах имэйл илгээх",
    verificationEmailSent: "Баталгаажуулах имэйл дахин илгээлээ.",
  ...
  cn: {
    ...
    unsave: "从收藏中删除",
    unsaveItemTitle: "确认删除吗?",
    unsaveItemConfirmation: "您确定要将此项目从收藏列表中删除吗?",
    unsaveButtonLabel: "删除",
    unsaveSuccessTitle: "成功",
    unsaveSuccessDesc: "已从您的收藏中删除。",
    unsaveErrorGeneric: "删除时出错。",
