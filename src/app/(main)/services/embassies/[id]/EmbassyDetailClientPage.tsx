          ...
          if (docSnap.exists()) {
            ...
            if (entryData.categoryName === "embassies") { 
              ...
              const showcaseItems: ShowcaseItem[] = (nestedData.delgerengui || []).map((detail: any) => ({
                ...
                imageUrl: detail.imageUrl || `https://placehold.co/400x300.png?text=${encodeURIComponent(detail.name || t('productUnnamed') || 'Info')}`,
                      ...
                      <Card key={index} className="overflow-hidden shadow-md hover:shadow-lg transition-shadow w-[280px] flex-shrink-0">
                        ...
                        <CardContent className="p-3">
                          ...
                          <CardDescription className="text-xs text-muted-foreground line-clamp-2">
                            {showcaseItem.description || t('noProductDescription')}
                          </CardDescription>
                        </CardContent>
                      </Card>
                    ))}
