...
export default function HospitalDetailClientPage({ params, itemType }: HospitalDetailClientPageProps) {
    ...
    if (itemId) {
      const fetchItem = async () => {
        ...
        try {
          ...
          console.error("Error fetching hospital entry:", error);
          setItem(null);
        } finally {
          setLoading(false);
        }
  ...
  const handleBookNow = async () => {
    ...
    try {
      const orderData: Omit<AppOrder, 'id'> = {
        ...
        dataAiHint: item.dataAiHint || "hospital building interior",
