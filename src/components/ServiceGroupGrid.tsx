  ...
  return (
    <div className="grid grid-cols-4 gap-x-2 gap-y-4 mt-2 mb-6"> {/* Changed my-8 to mt-2 mb-6 */}
      {SERVICE_GROUPS.map((service) => (
        ...
        >
          <div className="w-16 h-16 bg-accent rounded-full flex items-center justify-center mb-2 shadow-md group-hover:shadow-lg group-focus-visible:ring-2 group-focus-visible:ring-ring group-focus-visible:ring-offset-2 transition-all duration-300 ease-out group-hover:scale-110">
